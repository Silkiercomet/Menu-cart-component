            ...
            <div className={style.cart}>
                <section>
                    ...
                    {cart.map((item: ItemCart) => <div className={style.cart__item} key={item.product.name}>
                        <div className={style.cart__item_details}>
                            ...
                            <p><span>{item.amount}x</span>
                                <span>@ ${parseFloat(String(item.product.price)).toFixed(2)}</span>
                    ...
                    <div className={style.cart__total}><span>order total</span>
                        <span>${parseFloat(String(total_price)).toFixed(2)}</span></div>
                </section>
                <span className={style.cart__footer}> <img src={"./assets/images/icon-carbon-neutral.svg"}
                                                           alt={"carbon neutral order"}/> this is a <b> carbon neutral </b> delivery</span>
